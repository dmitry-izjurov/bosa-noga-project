                ...
                <div className="col">
                    <section>
                        ...
                        <ul className="nav flex-column">
                            <li className="nav-item"><Link to="/bosa-noga-project/about" className="nav-link">О магазине</Link></li>
                            <li className="nav-item"><Link to="/bosa-noga-project/catalog" className="nav-link">Каталог</Link></li>
                            <li className="nav-item"><Link to="/bosa-noga-project/contacts" className="nav-link">Контакты</Link></li>
                        </ul>
                    </section>
                </div>
                <div className="col">
